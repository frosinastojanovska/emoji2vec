...
class CliParser:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('-w', '--word', default='./data/glove/glove.twitter.27B.100d.txt.word2vec.bin',
        ...
        # Model parameters
        self.parser.add_argument('-k', '--dim', default=100, type=int, help='train a 100 x k projection matrix')
        ...
        self.model_params = ModelParams(100, out_dim=args.dim, pos_ex=args.batch, max_epochs=args.epochs,
